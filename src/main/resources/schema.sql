...
CREATE MEMORY TABLE IF NOT EXISTS "PUBLIC"."MATCH_ENTRY"(
    ...
    "KEY" CHARACTER VARYING(2047) NOT NULL,
    "WINNING_ALLIANCE" CHARACTER VARYING(2047)
);
ALTER TABLE "PUBLIC"."MATCH_ENTRY" ADD CONSTRAINT IF NOT EXISTS "PUBLIC"."CONSTRAINT_2CA0" PRIMARY KEY("KEY");
...
CREATE MEMORY TABLE IF NOT EXISTS "PUBLIC"."MATCH_ENTRY_VIDEOS"(
    ...
    "KEY" CHARACTER VARYING(2047),
    "MATCH_ENTRY_KEY" CHARACTER VARYING(2047) NOT NULL,
    "TYPE" CHARACTER VARYING(2047)
);
ALTER TABLE "PUBLIC"."MATCH_ENTRY_VIDEOS" ADD CONSTRAINT IF NOT EXISTS "PUBLIC"."CONSTRAINT_98" PRIMARY KEY("VIDEOS_ORDER", "MATCH_ENTRY_KEY");
...
ALTER TABLE "PUBLIC"."MATCH_ENTRY_VIDEOS" ADD CONSTRAINT IF NOT EXISTS "PUBLIC"."FKN5VRLLJ6Y5WCJCIQECU63KU60" FOREIGN KEY("MATCH_ENTRY_KEY") REFERENCES "PUBLIC"."MATCH_ENTRY"("KEY") NOCHECK;
